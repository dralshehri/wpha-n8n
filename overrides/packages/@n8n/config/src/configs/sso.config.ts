...
class SamlConfig {
	...
	/**
	 * Path to SP certificate file (combined cert and private key in PEM format)
	 * When set, automatically enables request signing
	 **/
	@Env('N8N_SSO_SAML_SIGNING_CERT_PATH')
