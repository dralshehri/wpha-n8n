...
export const BUTTON_STYLE_PRIMARY =
	'display:inline-block; text-decoration:none; background-color:#007A80; color: #fff; padding:12px 24px; font-family: Arial,sans-serif; font-size:14px;font-weight:600; border-radius:6px; min-width:120px; margin: 12px 2px 0 2px;';
...
export const ACTION_RECORDED_PAGE = `
	...
	<head>
		...
		<link rel='icon' href='/static/form-favicon.ico' />
		<link
